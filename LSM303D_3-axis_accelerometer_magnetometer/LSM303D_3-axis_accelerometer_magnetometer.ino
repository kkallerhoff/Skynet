...
{ 
  ...
  if(compass.a.x >= 500 || compass.a.x <= -500){
    buzzer.playNote(NOTE_G(3), 250, 8);
  }
 // if(compass.a.y >= 500 || compass.a.y <= -500){
 //   buzzer.playNote(NOTE_E(3), 250, 8);
 // }
 // if(compass.a.z >= 500 || compass.a.z <= -500){
 //   buzzer.playNote(NOTE_C(3), 250, 8);
 // }
